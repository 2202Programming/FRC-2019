...
public class TeleopArmControlCommand extends Command {
    ...
    protected void execute() {
        ...
        double extensionLength = MathUtil.limit(0, arm.EXTEND_MAX, (projection_cmd / Math.cos(Math.toRadians(90 - arm.getAbsoluteAngle()))) - arm.ARM_BASE_LENGTH - arm.WRIST_LENGTH);
